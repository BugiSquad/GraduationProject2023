                        ...
                        <Paper sx={{
                            ...
                            <div style={{
                                ...
                                <div style={{flexDirection: "column", alignContent: "flex-start"}}>
                                    <Typography sx={{p: 2}} fontSize={23}
                                                fontWeight={'bold'}>📨 {postItem.title}</Typography>
                                    <Typography sx={{paddingLeft: 2}}>{postItem.body}</Typography>
                                </div>
                                <Typography
                                    sx={{p: 2}}
                                    fontWeight={'bold'}>{`${getTimeFrom(Number(postItem.minutesLeftUntilMeal))} 후`}</Typography>
                                {postItem.interest.map((item, idx) => {
                                    return (<Chip sx={sx} label={item}></Chip>)
                                })}
                            </div>
                            <div style={{
                                display: "flex",
